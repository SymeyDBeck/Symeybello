const ownerNumber = ["558487775972@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '5587775972' 
// mude para seu numero

const callbotmsgs = ['DusBeck', 'Familia']
...
const menumsgimg = (numero, groupname, bat) => {
    return `MENU DO Symeyzinhokk COM 434 COMANDOS, BATERIA %${bat}`
}
